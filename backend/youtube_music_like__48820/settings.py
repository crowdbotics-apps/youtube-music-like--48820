"""
Django settings for youtube_music_like__48820 project.
...
ROOT_URLCONF = 'youtube_music_like__48820.urls'
...
WSGI_APPLICATION = 'youtube_music_like__48820.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "YouTube Music Like App Support <support@youtube-music-like--48820.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "youtube_music_like__48820 API",
    "DESCRIPTION": "API documentation for youtube_music_like__48820 App",
    "VERSION": "v1",
}
